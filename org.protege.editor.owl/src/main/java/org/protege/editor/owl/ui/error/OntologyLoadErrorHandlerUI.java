...
public class OntologyLoadErrorHandlerUI implements OntologyLoadErrorHandler {
    ...
    private ErrorExplainer createErrorExplainer() {
        ...
        errorFilter.addExplanationFactory(OBOFormatException.class,
                owlParserExceptionExplanationFac);
    ...
    public class ParseErrorsPanel extends JPanel{
        ...
        public ParseErrorsPanel(UnparsableOntologyException e, final URI loc) {
            ...
            for (OWLParserFactory factory : eKit.getOWLModelManager()
                    .getOWLOntologyManager().getOntologyParsers()) {
                Class<? extends OWLDocumentFormat> formatClass = factory
                        .getSupportedFormat().get().getClass();
                String parserClassName = factory.get().getClass()
                        .getSimpleName();
                format2ParserMap.put(formatClass, parserClassName);
            }
