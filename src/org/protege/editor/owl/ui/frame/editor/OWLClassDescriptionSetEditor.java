 ...
 */
public class OWLClassDescriptionSetEditor extends AbstractOWLFrameSectionRowObjectEditor<Set<OWLClassExpression>> implements VerifiedInputEditor {
    ...
    public OWLClassDescriptionSetEditor(OWLEditorKit owlEditorKit, java.util.List<OWLClassExpression> selectedClasses) {
        this.owlEditorKit = owlEditorKit;
