 ...
 * 21-Sep-2008<br><br>
 */
public class OWLEntitySelectorPanel2 extends JPanel implements OWLObjectSelector<OWLEntity>, Disposable {
    ...
    public OWLEntitySelectorPanel2(OWLEditorKit owlEditorKit) {
        this(owlEditorKit, true);
    }

    public OWLEntitySelectorPanel2(OWLEditorKit owlEditorKit, boolean multiselect) {
