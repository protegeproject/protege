 ...
 * 2019-04-25
 */
public class IdPolicyParser_MissingIdDigitCount_TestCase {

    private OWLOntology ontology;

    @Before
    public void setUp() throws Exception {
        InputStream is = IdPolicyParser_GO_TestCase.class.getResourceAsStream("/idpolicy/missing-iddigitcount-idranges.owl");
